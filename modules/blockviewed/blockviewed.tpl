...
<div id="viewed-products_block_left" class="viewed-products_block_left block products_block">
	<h4>{l s='Viewed products' mod='blockviewed'}</h4>
	<div class="block_content">
		<ul class="products viewed_products_liste clearfix">
			{foreach from=$productsViewedObj item=viewedProduct name=myLoop}
				<li class="clearfix {if $smarty.foreach.myLoop.last} last_item{elseif $smarty.foreach.myLoop.first} first_item{else} item{/if}">
					<div class="viewed_products_images">
                    ...
                    <div class="viewed_products_info">
                    	<div class="clearfix viewed_product_name">
                        <a href="{$viewedProduct->product_link}" title="{l s='More about' mod='blockviewed'} {$viewedProduct->name|escape:html:'UTF-8'}">{$viewedProduct->name|truncate:34:'...'|escape:html:'UTF-8'}</a>
                        </div>
                        <div class="text_desc viewed_product_desc">
