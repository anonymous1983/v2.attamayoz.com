...
{else}
	<!-- MODULE Block footer -->
	<div class="block_footer block_various_links block_various_links_footer" id="block_various_links_footer">
		...
		<ul>
			...
			{foreach from=$cmslinks item=cmslink}
				...
				{/if}
			{/foreach}
			{if $display_poweredby}<li class="last_item">{l s='Powered by' mod='blockcms'} <a href="http://karar-consulting.com/" target="_blank">karar Consulting/</a>&trade;</li>{/if}
		</ul>
	{$footer_text}
	</div>
	<!-- /MODULE Block footer -->
